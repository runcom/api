...
type MCOConfig struct {
	...
	Spec MCOConfigSpec `json:"spec" protobuf:"bytes,2,opt,name=spec"`
}
...
type MCOConfigList struct {
	...
	Items []MCOConfig `json:"items" protobuf:"bytes,2,rep,name=items"`
}
...
type ControllerConfigSpec struct {
	...
	Platform string `json:"platform" protobuf:"bytes,3,opt,name=platform"`

	EtcdDiscoveryDomain string `json:"etcdDiscoveryDomain" protobuf:"bytes,4,opt,name=etcdDiscoveryDomain"`

	// CAs
	EtcdCAData       []byte `json:"etcdCAData" protobuf:"bytes,5,opt,name=etcdCAData"`
	EtcdMetricCAData []byte `json:"etcdMetricCAData" protobuf:"bytes,6,opt,name=etcdMetricCAData"`
	RootCAData       []byte `json:"rootCAData" protobuf:"bytes,7,opt,name=rootCAData"`

	// PullSecret is the default pull secret that needs to be installed
	// on all machines.
	PullSecret *corev1.ObjectReference `json:"pullSecret,omitempty" protobuf:"bytes,8,opt,name=pullSecret"`

	// Images is map of images that are used by the controller.
	Images map[string]string `json:"images" protobuf:"bytes,9,rep,name=images"`

	// Sourced from configmap/machine-config-osimageurl
	OSImageURL string `json:"osImageURL" protobuf:"bytes,10,opt,name=osImageURL"`
}
...
type MachineConfigPoolSpec struct {
	...
	// default is 1.
	MaxUnavailable *intstr.IntOrString `json:"maxUnavailable" protobuf:"bytes,4,opt,name=maxUnavailable"`
}
...
type KubeletConfig struct {
	...
	Spec   KubeletConfigSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status KubeletConfigStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type KubeletConfigSpec struct {
	...
	KubeletConfig             *kubeletconfigv1beta1.KubeletConfiguration `json:"kubeletConfig,omitempty" protobuf:"bytes,2,opt,name=kubeletConfig"`
}
...
type ContainerRuntimeConfig struct {
	...
	Spec   ContainerRuntimeConfigSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status ContainerRuntimeConfigStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
